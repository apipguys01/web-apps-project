...
<div class="topbar">
    <div style="display:flex;align-items:center;gap:12px">
        ...
        <div>
            ...
            <div style="font-size:0.75rem;color:var(--muted);margin-top:2px">{{ $product->name }}</div>
        </div>
    </div>
</div>
...
<div style="display:grid;grid-template-columns:2fr 1fr;gap:20px">
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <div class="card-dark" style="padding:24px">
            ...
            <div style="margin-bottom:16px">
                ...
                <input type="text" name="name" value="{{ old('name', $product->name) }}" required class="form-control-dark">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:16px">
                <div>
                    ...
                    <input type="text" name="sku" value="{{ old('sku', $product->sku) }}" required class="form-control-dark">
        ...
        <div class="card-dark" style="padding:24px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                <div>
                    ...
                    <div style="position:relative">
                        ...
                        <input type="number" name="price" value="{{ old('price', $product->price) }}" min="0" required class="form-control-dark" style="padding-left:34px" oninput="calcMargin()">
                    </div>
                </div>
                <div>
                    ...
                    <div style="position:relative">
                        <span style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--muted);font-size:0.82rem">Rp</span>
                        <input type="number" name="cost_price" value="{{ old('cost_price', $product->cost_price) }}" min="0" required class="form-control-dark" style="padding-left:34px" oninput="calcMargin()">
                    </div>
                </div>
            </div>
            <div id="marginInfo" style="margin-top:12px;padding:10px 14px;background:var(--bg3);border-radius:8px;font-size:0.78rem;color:var(--muted2)">
                Margin: <span id="marginVal" style="font-weight:700;color:var(--green)">{{ $product->profit_margin }}%</span>
                &nbsp;·&nbsp; Laba per unit: <span id="profitVal" style="font-weight:700">Rp {{ number_format($product->price - $product->cost_price, 0, ',', '.') }}</span>
            </div>
        </div>
        ...
        <div class="card-dark" style="padding:24px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                <div>
                    <label style="font-size:0.72rem;font-weight:600;color:var(--muted2);display:block;margin-bottom:6px;text-transform:uppercase;letter-spacing:0.05em">Stok Saat Ini *</label>
                    <input type="number" name="stock" value="{{ old('stock', $product->stock) }}" min="0" required class="form-control-dark">
                </div>
                <div>
                    ...
                    <input type="number" name="min_stock" value="{{ old('min_stock', $product->min_stock) }}" min="0" required class="form-control-dark">
                </div>
            </div>
        </div>
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <div class="card-dark" style="padding:24px">
            ...
            <div id="imagePreview" style="width:100%;aspect-ratio:1;background:var(--bg3);border:2px dashed var(--border2);border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:pointer;margin-bottom:12px;overflow:hidden"
                ...
                @else
                    ...
                    <div style="font-size:0.75rem;color:var(--muted)">Klik untuk ganti foto</div>
                @endif
            </div>
        ...
        <div style="display:flex;flex-direction:column;gap:8px">
            <button type="submit" class="btn-green" style="padding:12px;font-size:0.88rem">💾 Update Produk</button>
            <a href="{{ route('products.index') }}" class="btn-outline" style="padding:11px;font-size:0.88rem;text-align:center;text-decoration:none">Batal</a>
        </div>
